...
public class HumanResourcesStatisticsTest {
	...
	public void before() {
		...
		w6 = new Worker("Monica", "Nichols", LocalDate.of(1992, 11, 14), new BigDecimal(99288), LocalDate.of(2017, 4, 6), new BigDecimal(7768));
		...
		w9 = new Worker("Melissa", "Meyers", LocalDate.of(1981, 10, 8), new BigDecimal(38334), LocalDate.of(2016, 6, 27), new BigDecimal(0));
		...
		w12 = new Worker("Sara", "Hall", LocalDate.of(1985, 9, 6), new BigDecimal(20286), LocalDate.of(2008, 11, 2), new BigDecimal(5985));
		...
		tr2 = new Trainee("Ronan", "Cardenas", LocalDate.of(1996, 7, 19), new BigDecimal(9063), LocalDate.of(2021, 9, 23), 120);
		...
		mngr2 = new Manager("Jason", "Hawkins", LocalDate.of(1991, 3, 30), new BigDecimal(181686), LocalDate.of(2021, 3, 17), new BigDecimal(5288),
				Arrays.asList(w7,w8,w9,w10,w11,tr2));
		director = new Manager("Christopher", "Freeman", LocalDate.of(1980, 2, 26), new BigDecimal(220863), LocalDate.of(2009, 3, 23), new BigDecimal(9983),
	...
	@Test
	public void salarySum() { //remove later
		System.out.println(
				_allEmployees.stream().reduce(0,
						(sum, employee) -> sum + employee.getSalary().intValue() , Integer::sum
				)
		);
	}
	@Test
	...
	public void bonusTotal() {
		System.out.println(HumanResourcesStatistics.bonusTotal(Arrays.asList(mngr1))); //implement
